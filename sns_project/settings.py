...
SECRET_KEY = 'django-insecure-l^$1@fb!fp)(bym$uir-argr1zt$c__%bll#xs%g$5jzkfszrp'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'sns_project', 'templates'), os.path.join(BASE_DIR, 'templates', 'accounts')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
